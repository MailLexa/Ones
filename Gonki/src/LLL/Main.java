...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CyclicBarrier Cyclic1 = new CyclicBarrier(5);
        CountDownLatch Cyclic2 = new CountDownLatch(CARS_COUNT);
        Race race = new Race(new Road(60), new Tunnel(), new Road(40));
        Car[] cars = new Car[CARS_COUNT];
        for (int i = 0; i < cars.length; i++) {
            cars[i] = new Car(race, 20 + (int) (Math.random() * 10),Cyclic1, Cyclic2);
        }
        for (int i = 0; i < cars.length; i++) {
